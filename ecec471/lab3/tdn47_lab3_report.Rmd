...
![Figure 5d: NAND ggate modified top level schematic](nand_top_schematic_mod.png)
...
The parametric analysis for the NAND gate cannot be conducted if the NMOS width is not increased since there won't be any PMOS width (> 90nm) that produce the switching potential of 0.6V. Therefore, when the NMOS width is chosen to be 200nm, the PMOS width of 90nm results in a symmetric device (Figure 6b).

![Figure 6a: NAND gate parametric analysis](nand_dc_sweep.png)
...
$$t_{r NAND} = 7.05552-7.01354 = 0.04198$$
$$t_{f NAND} = 8.05000-8.00848 = 0.04152$$

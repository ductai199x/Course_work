...
handle = Entrez.esearch(
    db="nucleotide",
    term="cytochrome oxidase i AND viridiplantae[Organism] and 450:2000[Sequence Length]",
)
...
handle1 = Entrez.esearch(
    db="nucleotide",
    term="cytochrome oxidase i AND fungi[Organism] and 450:2000[Sequence Length]",
)
...
handle2 = Entrez.esearch(
    db="nucleotide",
    term="cytochrome oxidase i AND animalia[Organism] and 450:2000[Sequence Length]",
)
...
print(
    "My plant: ",
    my_genbank_records[0]["GBSeq_organism"],
    "and its accession number: ",
    my_genbank_records[0]["GBSeq_primary-accession"],
)
print(
    "My fungi: ",
    my_genbank_records[1]["GBSeq_organism"],
    "and its accession number: ",
    my_genbank_records[1]["GBSeq_primary-accession"],
)
print(
    "My animal: ",
    my_genbank_records[2]["GBSeq_organism"],
    "and its accession number: ",
    my_genbank_records[2]["GBSeq_primary-accession"],
)
...
for i in range(len(my_genbank_records)):
    my_fasta_records.append(
        SeqRecord(
            Seq(my_genbank_records[i]["GBSeq_sequence"]),
            id=my_genbank_records[i]["GBSeq_primary-accession"],
            description=my_genbank_records[i]["GBSeq_definition"],
        )
    )
